...
<Main>
	<div class="compressed-content writing">
		...
		<p>
			...
			Before that, I was a senior frontend developer at
			<a href="https://shopify.com">Shopify</a>. In my spare time, I love hobby
			coding; I'm the maker and designer of the word games <i>Quina</i>
		...
		<p>
			...
			what my degree is in). Prior to that, I was a bartender and server, and
			regularly gigged as a musician, though that's all been many years ago now.
		</p>

		<p>
			I moved to the Kansas City area fairly recently, but was in Omaha for
