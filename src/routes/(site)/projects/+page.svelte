	...
	<div class="projects compressed-content double-wide">
		...
		<article>
			<div class="sticky">
				...
				<p>
					A sampling of some games and experiments I've built on <a
						href="https://codepen.io/collinsworth"
						rel="external">CodePen</a
					>, mostly in Vue, but some in React or vanilla JS as well.
				</p>
			</div>
			<ul class="codepens">
				<li>
					A <CodePenLink hash="XwPXrM">Sliding Puzzle in Vue</CodePenLink> (with
					an <CodePenLink hash="MMagLb">alternate version</CodePenLink> that converts
					images to sliding puzzles)
				</li>
				<li>
					A fun <CodePenLink hash="OYgGNK">Emoji Slider</CodePenLink> made with Vue
				</li>
				<li>
					An <CodePenLink hash="MLjVrQ">interactive Vue tutorial</CodePenLink> blog
					post
				</li>
				<li>
					The game of <CodePenLink hash="oNbavJN">Hangman</CodePenLink> in Vue, using
					a quotes API
				</li>
				<li>
					An <CodePenLink hash="bKXoRN"
						>Interactive CSS Filter React Component</CodePenLink
					>
				</li>
				<li>
					The classic <CodePenLink hash="Pymdxo">Color Flood Game</CodePenLink> build
					with React
				</li>
				<li>
				...
				<li>
					A (mostly) pure CSS exploration of making a completely different view
					at several breakpoints called <CodePenLink hash="jOYPjMB"
						>Retro Breakpoints of Infinity</CodePenLink
					>
				</li>
				<li>
				...
				<li>
					Some pure CSS illustrations, like this <CodePenLink hash="vdGYpo"
						>Raccoon Mario sprite</CodePenLink
					> and this <CodePenLink hash="LVMRwQ"
						>Pure CSS Game Boy Advance SP</CodePenLink
					>
				</li>
				<li>
					A mouse-tracking <CodePenLink hash="ExjZexY"
						>game of cat and mouse</CodePenLink
					>
				</li>
				<li>
					A small but handy <CodePenLink hash="bGdmmrY"
						>liquid measurement converter</CodePenLink
					> app
				</li>
				<li>
				...
				<li>
					<CodePenLink hash="ZEGrMRQ"
						>Generative typographic art grid</CodePenLink
					> in Vue
				</li>
				<li>
					A <CodePenLink hash="mdJmBQz">Hex/RGB(a)</CodePenLink> color converter
					in Vue
				</li>
			</ul>
		</article>
		...
		<article>
			...
			<ul>
				...
				<li>
					<a href="https://smitty.netlify.app" rel="external">"Smitty"</a>, the
					Super Metroid Item Tracker app built in Svelte
				</li>
				<li>
					<a href="https://wpmultisitedomainreplace.com" rel="external"
						>WPMultisiteDomainReplace.com</a
					>, a Nuxt app to update your WordPress multisite's database when
					switching main domains
				</li>
				<li>
					<a href="https://qvicklist.vercel.app/" rel="external">Qvick List</a>,
					an on-demand Vue to-do list app that saves to local storage. (Needs
					some updating.)
				</li>
				<li>
